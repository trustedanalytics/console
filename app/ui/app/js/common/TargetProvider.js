...
(function () {
    ...
    App.factory('targetProvider', ['$cookies', 'OrganizationResource', '$rootScope', '$q', 'NotificationService',

        function ($cookies, OrganizationResource, $rootScope, $q, NotificationService) {
