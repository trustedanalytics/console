...
(function () {
    ...
    /*jshint newcap: false*/
    App.controller('ManageOrganizationsController', ['$scope', 'OrganizationResource', '$stateParams', 'State', 'editableOptions',
        'editableThemes', 'targetProvider', '$state', 'OrganizationsModalsService', 'SpaceResource', 'NotificationService',
        function ($scope, OrganizationResource, $stateParams, State, editableOptions, editableThemes, targetProvider, $state,
                  OrganizationsModalsService, SpaceResource, NotificationService) {
