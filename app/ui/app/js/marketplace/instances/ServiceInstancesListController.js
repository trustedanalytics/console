...
(function () {
    ...
    App.controller('ServiceInstancesListController', ['$scope', 'State', 'targetProvider', 'ServiceInstancesResource', 'jsonFilter', 'blobFilter',
        function ($scope, State, targetProvider, ServiceInstancesResource, jsonFilter, blobFilter) {
